    ...
    C: ConnectionTrait,
{
    ...
    let moved_contract = contract_queries::move_rd_contract_to_rdi(contract_model, db).await?;
    ...
    let league_event_to_insert = league_event::ActiveModel {
        ...
        kind: ActiveValue::Set(LeagueEventKind::TeamUpdateToRdi),
