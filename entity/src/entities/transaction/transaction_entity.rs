...
fn validate_required_column_values_for_transaction_types(model: &ActiveModel) -> Result<(), DbErr> {
    match model.transaction_type.as_ref() {
        ...
        TransactionType::RookieDraftSelection => {
        ...
        TransactionType::TeamUpdateDropContract => {
        ...
        TransactionType::TeamUpdateToIr => {
        ...
        TransactionType::TeamUpdateFromIr => {
            if model.ir_contract_id.is_not_set() {
                return Err(DbErr::Custom(format!(
        ...
        TransactionType::RookieContractActivation => {
        ...
        TransactionType::TeamUpdateConfigChange => (),
        TransactionType::PreseasonKeeper => (),
        TransactionType::PreseasonStart => (),
    }
