...
pub fn create_dropped_contract(
    ...
    let new_contract = contract::ActiveModel {
        ...
        salary: ActiveValue::Set(match current_contract.contract_type {
            ...
            ContractType::Rookie => current_contract.salary,
            ContractType::RestrictedFreeAgent => 1,
            ContractType::RookieExtension => current_contract.salary,
            ContractType::UnrestrictedFreeAgentOriginalTeam => 1,
            ContractType::Veteran => current_contract.salary,
...
mod tests {
    ...
    fn drop_rd() -> Result<()> {
        ...
        let advanced_contract = create_dropped_contract(&test_contract)?;
